...
parser.add_argument('--malfunction',type=bool, default=False,help='whether introduce malfunction mechanism to signal system')
parser.add_argument('--gui',type=bool,default=True,help='whether use sumo or sumo-gui')
...
class Runner:
    ...
    def config_registry(self):
        ...
        if self.config['model'].get('graphic', False):
            ...
            print("QCY: roadnet_path:",roadnet_path)
    ...
    def run(self):
        ...
        print("QCY: task_mapping: ", Registry.mapping['task_mapping'])
        print("QCY: GPU: "+args.ngpu)
        self.task.run()
