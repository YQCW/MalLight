...
class TSCTask(BaseTask):
    ...
    def run(self):
        ...
        :return: None
        '''
        print("QCY: model_mapping setting train_model: ",Registry.mapping['model_mapping']['setting'].param['train_model'])
        print("QCY: model_mapping setting test_model: ",Registry.mapping['model_mapping']['setting'].param['test_model'])
        try:
